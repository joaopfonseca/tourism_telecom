...
function getUniforms() {
  ...
  if (opts.pickingSelectedColor !== undefined) {
    var selectedColor = opts.pickingNullColor || DEFAULT_MODULE_OPTIONS.pickingNullColor;
    if (opts.pickingSelectedColor) {
      selectedColor = [opts.pickingSelectedColor[0], opts.pickingSelectedColor[1], opts.pickingSelectedColor[2]];
